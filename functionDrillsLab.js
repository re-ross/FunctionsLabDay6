...
//CODE HERE
function trolleyForRon(gold) {
  let frogResult = gold / 3;
  return frogResult;
}

totalFrogs = trolleyForRon(210);
...
//CODE HERE
function trolleyForRon2(gold) {
  let frogResult = gold / 3;
  return Math.floor(frogResult);
}

totalFrogs2 = trolleyForRon2(4);
